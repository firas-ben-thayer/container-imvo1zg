...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-imvo1zg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-imvo1zg.containers.anotherwebservice.com/
...
```
git clone git@github.com:firas-ben-thayer/container-imvo1zg.git
cd container-imvo1zg
```
...
```
docker attach container-imvo1zg
```
